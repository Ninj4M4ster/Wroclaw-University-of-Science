...
/**
 * Specjalny dialog wywolywany w celu dodania wartosci do drzewa przez klienta.
 */
class DialogDodania { 
    ...
    public static String uruchomDialog() {
        ...
        Label opis_okna = new Label("Wprowadz wartosc do dodania do drzewa.");
        ...
        stage.setTitle("Dodawanie nowego wezla");
