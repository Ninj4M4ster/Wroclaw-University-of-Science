...
/**
 * Specjalny dialog wywolywany w celu usuniecia wartosci z drzewa przez klienta.
 */
class DialogUsuniecia { 
    ...
    public static String uruchomDialog() {
        ...
        Label opis_okna = new Label("Wprowadz wartosc do usuniecia z drzewa.");
