...
int main() {
  ...
  auto diff_and_quant = quantitizer.encode(ph, 2);
  outputPhoto("diff_quant_res.tga", "data/example0.tga", diff_and_quant.first);
  outputPhoto("quant_res.tga", "data/example0.tga", diff_and_quant.second);
}